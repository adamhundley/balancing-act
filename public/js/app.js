...
$(document).ready(function () {
  ...
  $('.submit-btn').on('click', function (e) {
    e.preventDefault();
    var $el = $(e.target);
    var $form = $el.parents('.message-form');
    var message = $form.find('.new-message').val();
  ...
  $('.message-form').on('click', function (e) {
    ...
    var $el = $(e.target);
    var id = $el.data('id');
    var $row = $el.parents('.message-row-wrapper');
...
__webpack_require__(/*! /Users/adamhundley/Documents/Challenges/balancing-act/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/adamhundley/Documents/Challenges/balancing-act/resources/sass/app.scss */"./resources/sass/app.scss");
